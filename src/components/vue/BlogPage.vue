            ...
            <div class="w-full flex flex-col gap-10 max-w-40 md:max-w-80">
                <div class="flex md:flex-row flex-col gap-2">
                    <IconField>
                        ...
                        <InputText placeholder="Busca no blog... " class="w-full" />
                    </IconField>
                </div>
                ...
                <div class="flex flex-col gap-5 items-start">
                    ...
                    <form class="flex flex-col gap-3 w-full">
                        <InputText placeholder="Seu e-mail" class="w-full py-4 px-4" />
                        <InputText placeholder="Seu nome" class="w-full py-4 px-4" />
                        <Button label="Receber novidades" severity="secondary" class="w-full h-14" rounded="full" />
                    </form>
                </div>
                ...
                <div class="flex flex-col gap-6 items-start">
                    ...
                    <div class="flex flex-col gap-8">
                        <a v-for="post in mostAccessedPosts" 
                           :key="post.position"
                           :href="post.url"
                        ...
                        >
                            <div class="relative min-w-[60px] h-[60px] rounded-lg">
                                <div class="absolute top-0 left-3 w-6 h-6 bg-primary-500 rounded-full flex items-center justify-center text-white text-sm font-bold -translate-y-1/2 -translate-x-1/2">
                                    {{ post.position }}º
                                </div>
                                <img 
                                    :src="post.image.src" 
                            ...
                            <h4 class="text-surface-900 font-medium group-hover:text-primary-500 transition-colors">
                                {{ post.title }}
                            </h4>
                        </a>
                    </div>
...
const tags = [
    ...
    { label: 'Alugar imóvel em presidente prudente', url: '/blog/tag/alugar-imovel-em-presidente-prudente' },
...
const blogPosts = [
    ...
    },
    {
        ...
        description: 'Descubra os principais fatores a considerar na hora de escolher o bairro ideal para sua nova casa...',
        date: '03/01/2023',
        category: 'DICAS',
    ...
    },
    {
        ...
        description: 'Um guia completo sobre como funciona o financiamento imobiliário e quais são as melhores opções...',
        date: '01/01/2023',
