...
class Imovel {
  ...
  async exclusiveRentedByType(type, pageQuantity, page, sortOrder) {
    const url = this.buildUrl(`/filtro?tipo_operacao=2&finalidade=null&tipo_imovel=${type}&cidade=null&bairro=null&qte_quartos=null&qte_suite=null&qte_vagas_garagem=null&qte_banheiros=null&area_util=null&cond_res_ed=null&valor_max=99999999999&valor_min=null&codigo_imovel=null&permuta=null&lancamento=null&video=null&exclusivo=S&pagina=${page}&qtdPagina=${pageQuantity}&ordenacao=${sortOrder}`)
    const request = await this.request('GET', url)
    return request
  }

  async exclusiveSaleByType(type, pageQuantity, page, sortOrder) {
    const url = this.buildUrl(`/filtro?tipo_operacao=1&finalidade=null&tipo_imovel=${type}&cidade=null&bairro=null&qte_quartos=null&qte_suite=null&qte_vagas_garagem=null&qte_banheiros=null&area_util=null&cond_res_ed=null&valor_max=99999999999&valor_min=null&codigo_imovel=null&permuta=null&lancamento=null&video=null&exclusivo=S&pagina=${page}&qtdPagina=${pageQuantity}&ordenacao=${sortOrder}`)
    const request = await this.request('GET', url)
    return request
  }
